...
[T0,dT0] = feval(mfilename,getSplineCoefficients(TD,'dim',1),omega,xc);
...
[Tc,dT] = feval(mfilename,getSplineCoefficients(TD,'dim',2),omega,xc);
DD = reshape([XD;TD(:)],[],3);
...
[Tc,dT] = feval(mfilename,getSplineCoefficients(TD,'dim',3),omega,xc);
